...
local function open_window()
    ...
    api.nvim_set_keymap("n", "J", "<Esc>:lua require('migrate-move').move_down()<CR>", { silent = true })
    api.nvim_set_keymap("n", "K", "<Esc>:lua require('migrate-move').move_up()<CR>", { silent = true })
    update()
end
